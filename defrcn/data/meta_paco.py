...
# Copy of load_json() in paco/paco/data/datasets/paco.py
def load_paco_json(json_file, image_root, dataset_name=None, extra_annotation_keys=None):
    """
...
# Adaptation of register_instances() in paco/paco/data/datasets/paco.py
def register_meta_paco(name, metadata, imgdir, annofile):
    DatasetCatalog.register(
        name,
        lambda: load_paco_json(annofile, imgdir, name),
    )
    #
    # split base-novel
    #
